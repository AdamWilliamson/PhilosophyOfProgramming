...
//            var fieldChainValidator = new FieldDescriptor<AllFieldTypesDto, int>(owningScope, ExpressionUtilities.GetPropertyPath((AllFieldTypesDto x) => x.Integer));
...
//            // Act
//            // Assert
//            fieldChainValidator.Matches(ExpressionUtilities.GetPropertyPath((AllFieldTypesDto x) => x.Integer)).Should().BeTrue();
//        }
