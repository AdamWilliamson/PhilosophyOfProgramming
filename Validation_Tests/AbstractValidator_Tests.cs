...
//            var runner = new ValidationRunner<AllFieldTypesDto>(new List<IScopedValidator<AllFieldTypesDto>>()
//            {
//                validator
//            });
...
//            // Assert
//            //((IScopedValidator<AllFieldTypesDto>)validator).GetScope().GetChildScopes().Count.Should().Be(2);
//            results.FieldErrors.Should().HaveCount(4);
//        }
