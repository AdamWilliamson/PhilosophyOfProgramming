...
//            Action<ChildAbstractValidator<TValidationType, TListItem>> rules
//        )
//        {
...
//        protected Action<ChildAbstractValidator<TValidationType, TListItem>> Rules { get; }
...
//                Rules.Invoke( new ChildAbstractValidator<TValidationType, TListItem>(parentScope)); //validationScope.CreateFieldObjectValidator(propExpr)
//            }
//        }

//        public void ActivateToDescribe(IValidationContext context)
//        {
//            Rules.Invoke(new ChildAbstractValidator<TValidationType, TListItem>(parentScope));
//        }
//    }
//}